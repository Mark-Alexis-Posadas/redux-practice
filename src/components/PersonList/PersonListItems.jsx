import { openModal } from "../../features/person-list/personListData";

export default function PersonListItems({ item, dispatch }) {
  return (
    <tr className="bg-white hover:bg-slate-50 border-b dark:bg-gray-800 dark:border-gray-700">
